        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">
              {locale === 'ar' ? 'سجلات المراجعة' : 'Audit Logs'}
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{locale === 'ar' ? 'إجمالي الإجراءات' : 'Total Actions'}</p>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{locale === 'ar' ? 'المستخدمون النشطون' : 'Active Users'}</p>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{locale === 'ar' ? 'الإجراءات الفاشلة' : 'Failed Actions'}</p>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{locale === 'ar' ? 'الإجراءات الناجحة' : 'Successful Actions'}</p>
        ...
        <Card className="p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Select value={actionFilter} onValueChange={setActionFilter}>
              <SelectTrigger>
                <SelectValue placeholder={locale === 'ar' ? 'كل الإجراءات' : 'All Actions'} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="ALL">{locale === 'ar' ? 'كل الإجراءات' : 'All Actions'}</SelectItem>
            ...
            <Select value={entityFilter} onValueChange={setEntityFilter}>
              <SelectTrigger>
                <SelectValue placeholder={locale === 'ar' ? 'كل الكيانات' : 'All Entities'} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="ALL">{locale === 'ar' ? 'كل الكيانات' : 'All Entities'}</SelectItem>
            ...
            {filteredLogs.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg">
                  {locale === 'ar' ? 'لا توجد سجلات مراجعة' : 'No audit logs found'}
                </p>
              </div>
            ) : (
                ...
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">
                      {locale === 'ar' ? 'التاريخ والوقت' : 'Timestamp'}
                    </th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">
