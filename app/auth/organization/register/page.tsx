...
export default function OrganizationRegisterPage() {
  ...
  const handleSignUp = () => {
    // Redirect to Auth0 signup with organization user type
    window.location.href = `/api/auth/login?screen_hint=signup&user_type=organization&returnTo=/organization/dashboard`
  }
